...
/**
 * Real SMTP delivery via nodemailer. Selected by MailModule when SMTP_HOST is
 * configured; otherwise the LogMailTransport is used. Works with any SMTP
 * provider (SES SMTP interface, SendGrid, Postmark, Mailtrap, …).
 */
